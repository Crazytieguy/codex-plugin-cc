...
function handleSessionStart(input) {
  ...
  // fresh empty env dir) and fires SessionStart with source="resume" on older Claude
  // Code versions, or source="fork" since 2.1.214; skipping writes there leaves
  // `codex-companion` off PATH for the remainder of that session.
  ...
  // On resume and fork the conversation context is preserved, so don't re-emit the
  // status systemMessage or re-inject the help text.
