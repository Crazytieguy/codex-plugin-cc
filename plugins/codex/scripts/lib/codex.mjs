  ...
  try {
    ...
    if (savedBrokerEndpoint && isConnectionError(error)) {
      ...
      try {
        ...
        return await getCodexAuthStatusFromClient(fallbackClient, cwd);
      } catch (fallbackError) {
        return buildAuthStatus({
          loggedIn: false,
...
function isConnectionError(error) {
  ...
  return /ECONNREFUSED|ENOENT|connect EACCES|socket hang up/i.test(message);
}
